...
const data = [
    { label: 'Physical Gift Card', value: '1' },
    { label: 'Digital Gift Card', value: '2' },
]
...
function DashboardGoogleScreen() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.container1}>
                <Text style={styles.text}>Google Play Gift Card</Text>
            </View>
            <View style={styles.container2}>
                <Text style={styles.text1}>
                    <Text style={{ fontWeight: 'bold' }}>N360.00</Text> is our conversion rate for every Google Play card on this platform
                </Text>
                <LinearGradient colors={['#99FDD9', '#1E62A1']} start={{ x: 1, y: 0 }} end={{ x: 1, y: 1 }} style={styles.card}>
                </LinearGradient>
                <Image style={{ width: 319, height: 200, zIndex: 1, position: 'absolute', }} source={require('../assets/GooglePlay.png')} />
            </View>
...
export default DashboardGoogleScreen;